...
class StepperControlWidget(QFrame):
    def __init__(self, stepperController, main=None, *args, **kwargs):
    ...
    def add_components(self):
        ...
        self.label_Speed.setNum(0)
        self.label_Speed.setFrameStyle(QFrame.Panel | QFrame.Sunken)
        
        self.entry_Speed = QDoubleSpinBox()
        self.entry_Speed.setMinimum(-10000) 
        self.entry_Speed.setMaximum(10000) 
        self.entry_Speed.setSingleStep(10)
        self.entry_Speed.setValue(1000)
        # self.entry_Speed.setDecimals(0)

        self.slider_Speed = QSlider(Qt.Horizontal)
        self.slider_Speed.setTickPosition(QSlider.TicksBelow)
        self.slider_Speed.setMinimum(-10000)
        ...
        self.btn_set_speed.setDefault(False)

        self.label_Microsteps = QLabel()
        self.label_Microsteps.setNum(0)
        self.label_Microsteps.setFrameStyle(QFrame.Panel | QFrame.Sunken)
    
        self.entry_Microsteps = QComboBox()
        self.entry_Microsteps.addItem('8')
        self.entry_Microsteps.addItem('16')
        self.entry_Microsteps.addItem('32')
        self.entry_Microsteps.addItem('64')
        self.entry_Microsteps.setCurrentText('8')

        self.btn_set_microsteps = QPushButton('Set Microsteps')
        self.btn_set_microsteps.setDefault(False)

        grid_line0 = QGridLayout()
        grid_line0.addWidget(QLabel('Speed control'), 0,0)
        grid_line0.addWidget(self.label_Speed, 0,1)
        grid_line0.addWidget(self.entry_Speed, 0,2)
        grid_line0.addWidget(self.btn_set_speed, 0,3)
        # grid_line0.addWidget(self.slider_Speed, 1, 0, 1, 3)

        grid_line1 = QGridLayout()
        grid_line1.addWidget(QLabel('Microsteps control'), 0,0)
        grid_line1.addWidget(self.label_Microsteps, 0,1)
        grid_line1.addWidget(self.entry_Microsteps, 0,2)
        grid_line1.addWidget(self.btn_set_microsteps, 0,3)
        ...
        # self.entry_Speed.valueChanged.connect(self.update_slider_value)
        # self.slider_Speed.valueChanged.connect(self.update_entry_value)

        # self.slider_Speed.valueChanged.connect(self.update_speed_label)
        self.entry_Microsteps.activated.connect(self.update_microsteps_value)

        self.btn_set_speed.clicked.connect(self.set_stepper_speed)
        self.btn_set_microsteps.clicked.connect(self.set_microsteps)
        
    def set_stepper_speed(self):
        value = round(self.entry_Speed.value())

        self.stepperController.set_stepper_speed(value)
        self.label_Speed.setNum(value)

        print('set speed')

    def set_microsteps(self):
        value = int(self.entry_Microsteps.currentText())
        self.stepperController.set_microsteps(value)
        self.label_Microsteps.setNum(round(value))

        print('set microsteps')

    def update_entry_value(self, value):

        self.entry_Speed.setValue(int(value))

    def update_speed_label(self, value):

        self.label_Speed.setNum(round(value))

    def update_microsteps_value(self, value):
        pass
        # self.entry_Microsteps.setValue(value)
